    ...
    <!-- Your content here -->
				<div class="content">
					<div class="container-fluid">
                        ...
                        <p>Periode: <?= $dateStartFormatted ?> - <?= $dateEndFormatted ?></p>
						<div class="row">
                            <div class="col-md-4">
                                            ...
                                            <table class="table table-striped table-bordered" style="width:100%" id="listTransactions">
                                                ...
                                                <tbody>
                                                    <?php foreach ($listTransactions as $transaction) : ?>
                                                        <tr class="<?= $transaction['type'] == 'Pemasukan' ? 'bg-success' : '' ?>">
                                                            <td><?= $transaction['date'] ?></td>
                                                            <td><?= $transaction['title'] ?></td>
                                                            <td>Rp. <?= number_format($transaction['amount'], 0, ',', '.') ?> <p><?= $transaction['type'] . ' -' . $transaction['category'] ?></p></td>
                                                            <td>
